...
-- (EN MYSQL DA PROBLEMAS SI PONEMOS EL max(count(dni_periodista)) Y LA ÚNICA FORMA DE SACAR ESTA CONSULTA EN MYSQL ERA ASÍ)
...
SELECT * FROM Periodista WHERE TIMESTAMPDIFF(MONTH, f_nacimiento, now()) < 336 
